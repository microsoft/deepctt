"""This file contains the utility functions for the Higgs dataset.

Adapated from: https://github.com/fengliu90/DK-for-TST/blob/master/utils_HD.py
License: MIT
...
NOTE: We make the following modifcations to the original code:
- We comment out methods that use the freqopttest package.
- We remove truncation of negative values to avoid Torch issues.
"""
